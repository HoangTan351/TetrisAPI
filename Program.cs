...
{
    sConnection = "Server=HOANGTAN;Database=Tetris;User Id=HoangTan;Password=Hoangtan1234";
}
...
{
    httpClient.BaseAddress = new Uri("https://localhost:3333/index.html");
    httpClient.DefaultRequestHeaders.Add(
        HeaderNames.UserAgent, "https://localhost:3333/index.html");
});
